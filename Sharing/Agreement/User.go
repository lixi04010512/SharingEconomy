...
//
// Solidity: function orderData(uint256 ) view returns(address orderOwner, address orderBorrower, uint256 oId, uint256 id, uint256 deal, uint256 back)
func (_User *UserCaller) OrderData(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Deal = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.Back = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
...
//
// Solidity: function agreeBack(uint256 id, uint256 backs, string over) payable returns()
...
//
// Solidity: function agreeBorrow(uint256 id, uint256 deal, string since) returns(uint256)
...
//
// Solidity: function dealHash(uint256 id, uint256 deal, uint256 oid) returns()
func (_User *UserTransactor) DealHash(opts *bind.TransactOpts, id *big.Int, deal *big.Int, oid *big.Int) (*types.Transaction, error) {
	return _User.contract.Transact(opts, "dealHash", id, deal, oid)
}

// DealHash is a paid mutator transaction binding the contract method 0x94d8ad51.
//
// Solidity: function dealHash(uint256 id, uint256 deal, uint256 oid) returns()
func (_User *UserSession) DealHash(id *big.Int, deal *big.Int, oid *big.Int) (*types.Transaction, error) {
	return _User.Contract.DealHash(&_User.TransactOpts, id, deal, oid)
}

// DealHash is a paid mutator transaction binding the contract method 0x94d8ad51.
//
// Solidity: function dealHash(uint256 id, uint256 deal, uint256 oid) returns()
func (_User *UserTransactorSession) DealHash(id *big.Int, deal *big.Int, oid *big.Int) (*types.Transaction, error) {
	return _User.Contract.DealHash(&_User.TransactOpts, id, deal, oid)
}
...
//
// Solidity: function disagreeBack(uint256 id, uint256 backs, string over) returns()
