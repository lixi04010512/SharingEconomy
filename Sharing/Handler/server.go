...
func Start(addr, webDir string) (err error) {
	...
	todo := r.Group("")
	{
		...
		todo.POST("/demandCount", demandCount)
	...
	share := r.Group("")
	{
		...
		share.GET("/index", BaseController{}.addIndex)
		share.GET("/cart", BaseController{}.CartGood)
		share.GET("/category-details/:Species", BaseController{}.CategoryDetails)
		...
		share.GET("/order", BaseController{}.MyOrder)
		...
		share.GET("/shop-product/:id", BaseController{}.shopPorduct)
		share.GET("/ui-me", UiMeStatic)
		share.GET("/wishlist", WishlistStatic)
		share.GET("/carts", BaseController{}.CartGood)
		...
		share.GET("/apps-invoice/:OId", AppInvoiceStatic)
