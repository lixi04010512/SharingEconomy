...
;(function(global,$){
	 ...
	 */
	 var cssMap={
		...
		'.toast-message__closeBtn:before':'{position:absolute;display:block;left:0;top:0;width:100%;height:100%;content:"脳";font-size:16px;}',
		...
		'.toast-icon--success:before':'{content:"鉁 ";color:#fff;}',
		...
		'.toast-icon--error:before':'{content:"脳";color:#fff;}',
